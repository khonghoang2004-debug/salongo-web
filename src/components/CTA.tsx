    ...
    >
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <a
          ...
          className="mt-10 inline-flex items-center justify-center rounded-full bg-white px-10 py-4 text-lg font-semibold transition-all duration-300 hover:brightness-105 active:scale-[0.98]"
          style={{
