...
export async function SolutionsPageHero() {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg, rgba(252,231,243,0.28) 0%, rgba(250,240,255,0.22) 50%, rgba(255,255,255,1) 100%)",
      }}
    >
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-lg text-[#6B7280] sm:text-xl">
          {t("heroSubtext")}
        </p>
